...
var boom_png = require("../../images/fruit/boom.png");
var peach_png = require("../../images/fruit/peach.png");
var peach_png_1 = require("../../images/fruit/peach-1.png");
var peach_png_2 = require("../../images/fruit/peach-2.png");
var sandia_png = require("../../images/fruit/sandia.png");
var sandia_png_1 = require("../../images/fruit/sandia-1.png");
var sandia_png_2 = require("../../images/fruit/sandia-2.png");
var apple_png = require("../../images/fruit/apple.png");
var apple_png_1 = require("../../images/fruit/apple-1.png");
var apple_png_2 = require("../../images/fruit/apple-2.png");
var banana_png = require("../../images/fruit/banana.png");
var banana_png_1 = require("../../images/fruit/banana-1.png");
var banana_png_2 = require("../../images/fruit/banana-2.png");
var basaha_png = require("../../images/fruit/basaha.png");
var basaha_png_1 = require("../../images/fruit/basaha-1.png");
var basaha_png_2 = require("../../images/fruit/basaha-2.png");
var shadow = require("../../images/shadow.png");
...
var infos = {
	...
	boom: [ boom_png, 66, 68, 26, 0, 0, null ],
	peach: [ peach_png, 62, 59, 37, -50, 0, "#e6c731" ],
	sandia: [ sandia_png, 98, 85, 38, -100, 0, "#c00" ],
	apple: [ apple_png, 66, 66, 31, -54, 0, "#c8e925" ],
	banana: [ banana_png, 126, 50, 43, 90, 0, null ],
	basaha: [ basaha_png, 68, 72, 32, -135, 0, "#c00" ]
};
...
ClassFruit.prototype.set = function( hide ){
	...
	this.shadow = layer.createImage( "fruit", shadow, this.startX - radius, this.startY - radius + shadowPos, 106, 77 );
...
ClassFruit.prototype.apart = function( angle ){
	...
	let bImageMap = {
		apple: [apple_png_1, apple_png_2],
		peach:[peach_png_1,peach_png_2],
		sandia:[sandia_png_1,sandia_png_2],
		banana:[banana_png_1,banana_png_2],
		basaha:[basaha_png_1,basaha_png_2]
	}

	this.bImage1 = create( "fruit", bImageMap[this.type][0] );
	this.bImage2 = create( "fruit", bImageMap[this.type][1] );
