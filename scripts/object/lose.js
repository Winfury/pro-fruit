...
var x = require( "../../images/x.png" );
var xx = require( "../../images/xx.png" );
var xxx = require( "../../images/xxx.png" );
var xf = require( "../../images/xf.png" );
var xxf = require( "../../images/xxf.png" );
var xxxf = require( "../../images/xxxf.png" );
var lose_png = require("../../images/lose.png");
...
var conf1 = { src: x, sx: 650, ex: 561, y: 5, w: 22, h: 19 };
var conf2 = { src: xx, sx: 671, ex: 582, y: 5, w: 27, h: 26 };
var conf3 = { src: xxx, sx: 697, ex: 608, y: 6, w: 31, h: 32 };
...
exports.showLoseAt = function( x ){
    ...
    infx = inf[ ( ++ number ) - 1 ];
    infx[0].attr( "src", xxxf ).scale( 1e-5, 1e-5 );
...
function createPosShow( x ){
    var image = layer.createImage( "default", lose_png, x - 27, 406, 54, 50 ).scale( 1e-5, 1e-5 );
    var duration = 500;
